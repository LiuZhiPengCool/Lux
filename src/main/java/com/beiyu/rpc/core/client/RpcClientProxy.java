package com.beiyu.rpc.core.client;

import com.beiyu.rpc.core.codec.RpcRequestBody;
import com.beiyu.rpc.core.codec.RpcResponseBody;
import com.beiyu.rpc.core.rpc_protocol.RpcRequest;
import com.beiyu.rpc.core.rpc_protocol.RpcResponse;
...
public class RpcClientProxy implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        // 1.将调用所需的信息编码成bytes[]，即有了调用编码 [codec层]
        ...
        // 4.解析RpcResponse，也就是在解析协议 [protocol层]
